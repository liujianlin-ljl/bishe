...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
        ...
        <script language="javascript">
            ...
            function callback(data)
            {
               ...
               // window.parent.location = "/admin?type=exit";
            }
          //返回 
	        function back(){
	...
	<body  style="background:url('<%=path %>/img/bg05.jpg');background-size:100%;">
			...
			<table width="50%" align="center" border="0" cellpadding="4" cellspacing="1" bgcolor="#CBD8AC" style="margin-top:100px;height:220px;">
				<tr bgcolor="#EEF4EA">
